...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul 13 16:16:49 2022
...
data_dir = Path("/home/josemo/opencv/captcha/captcha_images_v2/")
...
# Maximunlength of any captchua in the dataset
...
def split_data(images, labels, train_size=0.9, shuffle=True):
    # 1. Get the total size of dataset
    size = len(images)
...
# Model
#A Connectionist Temporal Classification Loss, or CTC Loss,
# is designed for tasks where we need alignment between sequences,
# but where that alignment is difficult
...
def decode_batch_predictions(pred):
    ...
    # Use gready search.  For complete tasks, you can use beam search
